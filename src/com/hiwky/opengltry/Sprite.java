...
class Sprite
{
    ...
    public Sprite()
    {
        ...
        base = new RectF(-50f*GLRenderer.ssu,50f*GLRenderer.ssu, 50f*GLRenderer.ssu, -50f*GLRenderer.ssu);
         
        // Initial translation
        translation = new PointF(50f*GLRenderer.ssu,50f*GLRenderer.ssu);
